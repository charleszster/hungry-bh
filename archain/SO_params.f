...
C***********************************************************************
     ...
     & - 4.0*RCORE*(-3.0*PI*r**2.0 + PI*RCORE**2.0 + r*RCORE - 
     & (-6.0*r**2.0 + 2.0*RCORE**2.0)*ATAN(RCORE/r))) +
     ...
     & 2.0*RPL**2.0)*ATAN(RPL/r))) + 0.167*r**(-3.0)*(PI*RCORE + r -
     & 2.0*RCORE*ATAN(RCORE/r)) + 0.5*r**(-2.0) + 0.5*RCORE**(-2.0)*
     ...
     & RCORE**2.0 + r*RCORE - (-6.0*r**2.0 + 2.0*RCORE**2.0)*
     & ATAN(RCORE/r))) + 0.04167*r**(-3.0)*RPL**(-2.0)*(-3.0*r**3.0*
     & (PI**2.0 - 4.0*ATAN(r/RPL)**2.0) + 16.0*r**3.0*LOG(r**(-2.0)*
     & RPL**2.0 + 1.0) - 4.0*RPL*(-3.0*PI*r**2.0 + PI*RPL**2.0 + r*RPL -
     & (-6.0*r**2.0 + 2.0*RPL**2.0)*ATAN(RPL/r))) + 0.0167*r**(-3.0)*
     & (PI*RCORE + r - 2.0*RCORE*ATAN(RCORE/r)) + 0.5*r**(-2.0) + 0.5*
     ...
     & RCORE**2.0 + 1.0) - 4.0*RCORE*(-3.0*PI*r**2.0 + PI*RCORE**2.0 +
     & r*RCORE - (-6.0*r**2.0 + 2.0*RCORE**2.0)*ATAN(RCORE/r))) +
     & 0.04167*r**(-3.0)*RPL**(-2.0)*(-3.0*r**3.0*(PI**2.0 - 4.0*
     & ATAN(r/RPL)**2.0) + 16.0*r**3.0*LOG(r**(-2.0)*RPL**2.0 + 1.0)
     & - 4.0*RPL*(-3.0*PI*r**2.0 + PI*RPL**2.0 + r*RPL - (-6.0*r**2.0 +
     & 2.0*RPL**2.0)*ATAN(RPL/r))) + 0.0167*r**(-3.0)*(PI*RCORE + r - 
     & 2.0*RCORE*ATAN(RCORE/r)) + 0.5*r**(-2.0) + 0.5*RCORE**(-2.0)*
     ...
     & LOG(r**(-2.0)*RPL**2.0 + 1.0) - 4.0*RPL*(-3.0*PI*r**2.0 + 
     & PI*RPL**2.0 + r*RPL - (-6.0*r**2.0 + 2.0*RPL**2.0)*ATAN(RPL/r)))+
     & 0.04167*r**(-3.0)*RPL**(-2.0)*(12.0*PI*r**2.0 - 4.0*PI*RPL**2.0 +
     & 32.0*r**1.0*RPL**1.0/(r**(-2.0)*RPL**2.0+1.0) - 4.0*r*RPL -
     & 24.0*r**4.0*ATAN(r/RPL)**1.0/(RPL**2*(r**2/RPL**2+1)) - 4.0*RPL*
     & (2.0*PI*RPL**1.0 + r - 4.0*RPL**1.0*ATAN(RPL/r) - (-6.0*r**2.0 +
     ...
     & r**(-3.0)*RCORE**(-2.0)*(-3.0*r**3.0*(PI**2.0 - 4.0*
     & ATAN(r/RCORE)**2.0) + 16.0*r**3.0*LOG(r**(-2.0)*RCORE**2.0 + 1.0)
     & -4.0*RCORE*(-3.0*PI*r**2.0 + PI*RCORE**2.0 + r*RCORE-(-6.0*r**2.0
     & + 2.0*RCORE**2.0)*ATAN(RCORE/r))) + 0.04167*r**(-3.0)*RPL**(-2.0)
     & *(-3.0*r**3.0*(PI**2.0 - 4.0*ATAN(r/RPL)**2.0) + 16.0*r**3.0*
     & LOG(r**(-2.0)*RPL**2.0 + 1.0) - 4.0*RPL*(-3.0*PI*r**2.0+PI*
     & RPL**2.0 + r*RPL - (-6.0*r**2.0 + 2.0*RPL**2.0)*ATAN(RPL/r))) +
     & 0.0167*r**(-3.0)*(PI*RCORE + r - 2.0*RCORE*ATAN(RCORE/r)) + 0.5*
     ...
     & *RPL**(-2.0)*(-3.0*r**3.0*(PI**2.0 - 4.0*ATAN(r/RPL)**2.0) +
     & 16.0*r**3.0*LOG(r**(-2.0)*RPL**2.0 + 1.0) -4.0*RPL*(-3.0*PI*
     & r**2.0 + PI*RPL**2.0 + r*RPL - (-6.0*r**2.0 + 2.0*RPL**2.0)*
...
C***********************************************************************
     ...
     & 3.0*r**2.0/(1 + RPL**2/r**2) + 3.0*RPL**2.0) - 0.1667*PI*
     & r**(-3.0)/RPL**2 + 1.5*PI*RPL**(-4.0)/r - 0.5*PI**2.0*
